...
class ParticipationsControllerTest < ActionController::TestCase
  ...
  test "should create participation" do
    assert_difference('Participation.count') do
      post :create, participation: { bottle_id: @participation.bottle_id, question_id: @participation.question_id, user_id: @participation.user_id }
    end
  ...
  test "should update participation" do
    put :update, id: @participation, participation: { bottle_id: @participation.bottle_id, question_id: @participation.question_id, user_id: @participation.user_id }
    assert_redirected_to participation_path(assigns(:participation))
  end
